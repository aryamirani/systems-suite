...
main(int argc, char **argv)
{
  ...
  16:	4905                	li	s2,1
    if((i & 31) == 0) write(1, ".", 1);
  18:	00001a97          	auipc	s5,0x1
  1c:	908a8a93          	addi	s5,s5,-1784 # 920 <malloc+0x126>
  for(i = 0; i < 512; i++){
  20:	20000a13          	li	s4,512
  24:	a831                	j	40 <main+0x40>
      printf("alloctest: sbrk failed at i=%d\n", i);
  26:	85a6                	mv	a1,s1
  28:	00001517          	auipc	a0,0x1
  2c:	8d850513          	addi	a0,a0,-1832 # 900 <malloc+0x106>
  30:	716000ef          	jal	746 <printf>
      exit(1);
  34:	4505                	li	a0,1
  36:	2d8000ef          	jal	30e <exit>
  for(i = 0; i < 512; i++){
  3a:	2485                	addiw	s1,s1,1
  3c:	03448263          	beq	s1,s4,60 <main+0x60>
    p[i] = sbrk(4096);
  40:	6505                	lui	a0,0x1
  42:	298000ef          	jal	2da <sbrk>
    if(p[i] == (char*)-1){
  46:	ff3500e3          	beq	a0,s3,26 <main+0x26>
    p[i][0] = 1;
  4a:	01250023          	sb	s2,0(a0) # 1000 <freep>
    if((i & 31) == 0) write(1, ".", 1);
  4e:	01f4f793          	andi	a5,s1,31
  52:	f7e5                	bnez	a5,3a <main+0x3a>
  54:	864a                	mv	a2,s2
  56:	85d6                	mv	a1,s5
  58:	854a                	mv	a0,s2
  5a:	2d4000ef          	jal	32e <write>
  5e:	bff1                	j	3a <main+0x3a>
  }
  printf("\nalloctest: done allocations\n");
  60:	00001517          	auipc	a0,0x1
  64:	8c850513          	addi	a0,a0,-1848 # 928 <malloc+0x12e>
  68:	6de000ef          	jal	746 <printf>
  // hold a bit, then exit
  pause(100);
  6c:	06400513          	li	a0,100
  70:	32e000ef          	jal	39e <pause>
  exit(0);
  74:	4501                	li	a0,0
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3fa:	55a50513          	addi	a0,a0,1370 # 950 <digits>
 3fe:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 690:	2c4b8b93          	addi	s7,s7,708 # 950 <digits>
 ...
 6f2:	25a90913          	addi	s2,s2,602 # 948 <malloc+0x14e>
        for(; *s; s++)
